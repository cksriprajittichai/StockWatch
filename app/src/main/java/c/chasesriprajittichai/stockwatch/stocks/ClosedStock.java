...
public final class ClosedStock extends AdvancedStock {
    ...
    public ClosedStock(final String ticker, final String name, final double priceAtClose,
        ...
        super(State.CLOSED, ticker, name, priceAtClose, changePointAtClose, changePercentAtClose, todaysLow,
