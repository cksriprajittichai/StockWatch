...
public final class PremarketStock extends AdvancedStock implements StockWithAfterHoursValues {
    ...
    public PremarketStock(final String ticker, final String name, final double priceAtClose,
                          ...
                          final List<Double> yData_1day, final List<Double> yData_2weeks,
                          final List<Double> yData_1month, final List<Double> yData_3months,
                          final List<Double> yData_1year, final List<Double> yData_5years,
        ...
        super(State.PREMARKET, ticker, name, priceAtClose, changePointAtClose, changePercentAtClose,
                todaysLow, todaysHigh, fiftyTwoWeekLow, fiftyTwoWeekHigh, marketCap, prevClose,
                peRatio, eps, yield, averageVolume, description, yData_1day, yData_2weeks,
                yData_1month, yData_3months, yData_1year, yData_5years, dates_2weeks, dates_1month,
                dates_3months, dates_1year, dates_5years);
